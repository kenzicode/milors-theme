...
class Theme_Widget_Recent_Posts extends WP_Widget {
	...
	public function __construct() {
		$widget_ops = array(
			...
			'description' => __( 'Milors special recent Posts.' ),
			'customize_selective_refresh' => true,
		);
		parent::__construct( 'recent-posts', __( 'Milors Recent Posts' ), $widget_ops );
	...
	public function widget( $args, $instance ) {
		...
		<div class="widget">
			<?php foreach ( $r->posts as $recent_post ) : ?>
				<?php
				$img =  wp_get_attachment_image_src( get_post_thumbnail_id($recent_post->ID), 'small-square', false, '' );
...
function register_Theme_Widget_Recent_Posts() {
    register_widget( 'Theme_Widget_Recent_Posts' );
}
add_action( 'widgets_init', 'register_Theme_Widget_Recent_Posts' );
