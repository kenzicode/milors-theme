...
if ( ! function_exists( 'milors_share_button' ) ) {
    ...
    $img =  wp_get_attachment_image_src( get_post_thumbnail_id( $post->ID ), 'fullsize' );
    ...
    $pinterest = 'https://pinterest.com/pin/create/button/?url=' . $permalink . '&amp;media=' . $img . '&amp;description=' . $postTitle;
